  ...
  <div>
    <Formik
      ...
      validate={(values) => {
        ...
        } else if (!/^\d{5}-?\d{3}$/i.test(values.extra.address_zip)) {
          errors.address_zip = "CEP inválido";
        } else if (
          !values.extra.address_city &&
          !values.extra.address_neighborhood &&
          !values.extra.address_street &&
          !values.extra.address_complement
        ) {
        ...
        if (!values.extra.address_number) {
          errors.address_number =
            "Digite o número de sua casa ou digite zero (O) se não houver número";
        }
        ...
        <Container>
          <Form>
            ...
            <Row>           
              ...
              <Field type="text" name="extra.address_zip" />
            </Row>

            <Row>
              <Form.Label>Cidade</Form.Label>
              <ErrorMessage name="address_city" component="div" />
              <Field type="text" name="extra.address_city" />
          
              <Form.Label>Bairro</Form.Label>
              <ErrorMessage name="address_neighborhood" component="div" />
              <Field type="text" name="extra.address_neighborhood" />
            </Row>

            <Row>
              <Form.Label>Rua</Form.Label>
              <ErrorMessage name="address_street" component="div" />
              <Field type="text" name="extra.address_street" />
           
              <Form.Label>Numero</Form.Label>
              <ErrorMessage name="address_number" component="div" />
              <Field type="text" name="extra.address_number" />
            </Row>

            <Row>
              <Form.Label>Complemento</Form.Label>
              <ErrorMessage name="address_complement" component="div" />
              <Field type="text" name="extra.address_complement" />
            </Row>

            <Row className="d-flex justify-content-center">
              <Button type="submit" variant="entrar" disabled={isSubmitting}>
                {" "}
                Cadastrar{" "}
              </Button>
            </Row>
